...
def train_kitti_mots_detectron2():
    ...
    output_dir = "./finetuning_output_final"
    ...
    cfg.SOLVER.MAX_ITER = 10000  # Increased for better convergence
    cfg.SOLVER.STEPS = (1000, 1500)  # Adjust learning rate at these iterations
    
    # Add evaluation during training
    cfg.TEST.EVAL_PERIOD = 2500  # Evaluate every 200 iterations
