...
class FirdDataset(Dataset):
    def __init__(self, csv_file, root_dir, tokenizer, max_len=64, transform=None):
        """
        Args:
...
def main():
    ...
    train_csv = os.path.join(root_dir, "clean_mapping_train.csv")
    validation_csv = os.path.join(root_dir, "clean_mapping_validation.csv")
